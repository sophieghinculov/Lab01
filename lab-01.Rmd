...
NA stands for Not Available, and we are getting that as an answer because there are some not available values on the data set. We need to remove these values to be able to take the mean and median. 
